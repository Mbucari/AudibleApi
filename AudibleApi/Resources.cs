...
public static class Resources
{
	...
	internal const string OsVersion = @"google\/raven\/raven:14\/UPB5.230623.003\/10615560:user\/release-keys";
	internal const string OsVersionNumber = "34";
	internal const string SoftwareVersion = "130050002";
	internal const string AppVersion = "2090263407";
	internal const string AppVersionName = "26.34.07";
	...
	internal const string DeviceProduct = "sdk_gphone64_x86_64";
	internal const string MapVersion = "MAPAndroidLib-1.3.57073.0";
